...
# Default chunk size: ~1200 bytes payload keeps us near one QUIC packet
# At 7 kbps: 1200 * 8 / 7000 ≈ 1.37 sec per chunk → manageable windows
DEFAULT_CHUNK = 1_200
...
def build_chunks(bundle_data: bytes,
    ...
    for seq in range(n_chunks):
        ...
        data_chunks.append(header + signature + payload)
